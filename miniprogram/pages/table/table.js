...
/* 筹码内 ★ 阵型：1~2 星居中/并排，3 星三角、4 星四方、5 星五边、6 星六边、
   7 星七边、8 星八边（星数 = 座位数，8 人局必须有 7/8 星，否则会退化成 1 星样式）
...
const STAR_POS = {
  ...
  7: [{ x: 50, y: 14 }, { x: 74, y: 28 }, { x: 79, y: 58 }, { x: 63, y: 82 }, { x: 37, y: 82 }, { x: 21, y: 58 }, { x: 26, y: 28 }],
  8: [{ x: 50, y: 14 }, { x: 71, y: 25 }, { x: 80, y: 50 }, { x: 71, y: 75 }, { x: 50, y: 86 }, { x: 29, y: 75 }, { x: 20, y: 50 }, { x: 29, y: 25 }],
};
...
Page({
  ...
  onShareAppMessage() {
    return {
      title: '筹码密语 · 正在执行第' + this.data.heist + '次劫案！',
      path: '/pages/home/home',
    };
  },
  onShareTimeline() { return { title: '筹码密语 · 合作扑克劫案' }; },
